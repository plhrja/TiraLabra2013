...
public class CellGrid implements Iterable<Cell>{
    ...
    /**
     * Constructor creates a grid of {@code Cell} objects with given row length and <br>
    ...
    /**
     * Constructor creates a grid of {@code Cell} objects with given row length and <br>
     * column length. Type of the {@code Cell} objects is defined by the {@code solid} parameter.
     * @param rowLength row length of the grid.
     * @param columnLength column length of the grid.
     ...
     * @return the {@code Cell} object at the given position determined by {@code row} and {@code column}
     */
